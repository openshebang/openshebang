...
# Setting up on Debian 11 (or Windows 10 with WSL2 Debian 11)
...
# Using DTL (Djano Template Language). DTL looks like Jinja2, but it is not.
...
# To make sure you can delete a full single app:
...
# Check the database with the Django Shell (`python3 mangage.py shell`)
...
# Show single item from database list
...
# Class-based views, in stead of functions created views
